function PrintMainMenu(sPageName, sTitle) {
  ...
  let sOut = '<div class="container-fluid">' +
    ...
    '<a href="' + (sPageName == "default.html" ? "https://github.com/mmeents" : "default.html") + '" style="font-size:large;color:black;font-weight:bolder;font-family:Arial, Helvetica, sans-serif;">' +
      sTitle + '</a>' +
    '</div>' +
